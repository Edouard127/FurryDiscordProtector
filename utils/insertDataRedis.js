...
const client = createClient({ url: `redis://default:${process.env.REDIS_MASTER_PASSWORD}@172.20.183.36:6379` })
client.connect()
...
class InsertRedis {
    ...
    async insert(id, data){
        ...
        await client.set(`server_${id}`, JSON.stringify(data)).catch((err, result) => {
