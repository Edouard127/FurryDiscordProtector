const languageData = {
        ...
        _stats_nerd_infos: (model, threads, clock, total_ram, free_ram, used_ram) => `Сделано для ботаников вроде тебя 🤓\n<:CPU:946565742055292949> Информация о процессоре:\nМодель: ${model}\nКоличество потоков: ${threads}\nчасы: ${clock} Ghz\n\n\n<:RAM:946581194793971712> RAM Информация:\n Всего RAM: ${total_ram}\nБесплатно RAM: ${free_ram}\nRAM Используется процессом: ${used_ram}`,
