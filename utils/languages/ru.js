const languageData = {
    ...
    _raid_: `⚠️Рейд⚠️`,
    _raid_message: `Предупреждение\nОбнаружен рейд\nУбедитесь, что отключили режим рейда с помощью &raidmode`,
